        ...
        datasets: [
            {
                ...
                backgroundColor: rainbowColors.slice(0, Object.keys(reasonCounts).length),
                borderRadius: 6
            }
        ]
    };
    ...
    return (
        <div className="flex min-h-screen bg-gray-100">
            ...
            <aside className="w-64 bg-white shadow-sm hidden md:flex flex-col p-6 space-y-6">
                <h2 className="text-xl font-bold text-gray-800">RouteVision</h2>
            ...
            <main className="flex-1 p-6 space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 p-6 rounded-2xl shadow-sm">
                    ...
                    <p className="text-blue-900 text-sm">
                        High failure concentration detected in Kothrud
                        and Baner, primarily during evening hours due to
                        customer unavailability. Recommend optimizing
